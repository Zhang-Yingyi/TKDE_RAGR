...
from models.rqvae_tiger import RQVAE
from trainer_tiger import  Trainer
import os
...
def parse_args():
    ...
    parser.add_argument("--rev_data_path", type=str, default="./data", help="data directory")
    ...
    parser.add_argument('--sk_epsilons', type=float, nargs='+', default=[0.0, 0.0, 0.0, 0.0, 0.003], help="sinkhorn epsilons")
    # parser.add_argument('--num_emb_list', type=int, nargs='+', default=[256,256,256,256], help='emb num of every vq')
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[256,256,256,256,256], help='emb num of every vq')
    ...
    # parser.add_argument('--layers', type=int, nargs='+', default=[256,128,64], help='hidden sizes of every layer')
...
if __name__ == '__main__':
    ...
    """build dataset"""
    data1 = EmbDataset(args.data_path)
    data2 = EmbDataset(args.rev_data_path)
    # data = data1+data2
    data = data1
    model = RQVAE(in_dim=data2.dim,
