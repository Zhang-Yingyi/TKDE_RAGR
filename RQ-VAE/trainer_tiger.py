...
class Trainer(object):
    ...
    def _train_epoch(self, train_data, epoch_idx):
        ...
        for batch_idx, data in enumerate(iter_data):
            ...
            loss, loss_recon, quant_loss = self.model.compute_loss(out, rq_loss, xs=data)
    ...
    def _generate_train_loss_output(self, epoch_idx, s_time, e_time, loss, recon_loss,quen_loss):
        # train_loss_output = (
        ...
        train_loss_output +=", "
        train_loss_output += "quantization loss" + ": %.4f" % quen_loss
    ...
    def fit(self, data):
        ...
        for epoch_idx in range(self.epochs):
            ...
            train_loss_output = self._generate_train_loss_output(
                epoch_idx, training_start_time, training_end_time, train_loss, train_recon_loss,quant_loss
            )
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                valid_end_time = time()
                valid_score_output = ("epoch %d evaluating"+ " ["+ "time"+ ": %.2fs, " + "collision_rate"+ ": %f]") % (epoch_idx, valid_end_time - valid_start_time, collision_rate)
